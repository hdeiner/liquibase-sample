...
This liquibase-project is ready to run with MySQL<br>
Dependency to mysql-connector is found in the maven pom.xml
...
In this example the database is called '**liquibasesample**'.<br>
You **have to** create the database before running the project<br>

  - see the liquibase.properties-file
    - setting: url=jdbc:mysql://localhost/liquibasesample
...
In this example every file has its responsibility<br>
  ...
  - The db.admin_config_values.sql contains example content.
